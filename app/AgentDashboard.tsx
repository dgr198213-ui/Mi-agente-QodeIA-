...
export default function AgentDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'chat' | 'credentials'>('chat');
  ...
  return (
    <div className="flex h-screen bg-[#0a0f0e] text-gray-100 font-sans overflow-hidden">
      ...
      <div className="w-64 bg-[#111817] border-r border-[#1a2e2a] flex flex-col">
        ...
        <div className="p-4 border-t border-[#1a2e2a] space-y-2">
          <button 
            onClick={() => setActiveTab('chat')}
            className={`w-full py-2 px-4 text-center rounded-lg text-sm transition-colors ${activeTab === 'chat' ? 'bg-[#0087b1] text-white' : 'bg-[#1a2e2a] text-gray-400 hover:bg-[#253f3a]'}`}
          >
            Terminal Chat
          </button>
          <button 
            onClick={() => setActiveTab('credentials')}
            className={`w-full py-2 px-4 text-center rounded-lg text-sm transition-colors ${activeTab === 'credentials' ? 'bg-[#0087b1] text-white' : 'bg-[#1a2e2a] text-gray-400 hover:bg-[#253f3a]'}`}
          >
            Credenciales
          </button>
          <a href="/admin/mcp" className="block w-full py-2 px-4 bg-[#1a2e2a] hover:bg-[#253f3a] text-center rounded-lg text-sm transition-colors text-gray-400">
            Configurar MCP
          </a>
        </div>
      </div>
